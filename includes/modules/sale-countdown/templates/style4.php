  ...
  <div class="s4-timer-wrap">
      ...
      <div class="s4-circle-item">
        <div class="s4-svg-wrapper">
          <svg width="64" height="64" class="s4-countdown-svg">
            <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" opacity="0.12" fill="<?php echo esc_attr($timer_bg); ?>" />
            <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" fill="none" stroke-linecap="round" stroke-dasharray="<?php echo esc_attr($circumference); ?>" stroke-dashoffset="0" transform="rotate(-90 32 32)" class="s4-circle-progress th-days-circle" />
    ...
    <div class="s4-circle-item">
      <div class="s4-svg-wrapper">
        <svg width="64" height="64" class="s4-countdown-svg">
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" opacity="0.12" fill="<?php echo esc_attr($timer_bg); ?>" />
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" fill="none" stroke-linecap="round" stroke-dasharray="<?php echo esc_attr($circumference); ?>" stroke-dashoffset="0" transform="rotate(-90 32 32)" class="s4-circle-progress th-hours-circle" />
    ...
    <div class="s4-circle-item">
      <div class="s4-svg-wrapper">
        <svg width="64" height="64" class="s4-countdown-svg">
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" opacity="0.12" fill="<?php echo esc_attr($timer_bg); ?>" />
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" fill="none" stroke-linecap="round" stroke-dasharray="<?php echo esc_attr($circumference); ?>" stroke-dashoffset="0" transform="rotate(-90 32 32)" class="s4-circle-progress th-minutes-circle" />
    ...
    <div class="s4-circle-item">
      <div class="s4-svg-wrapper">
        <svg width="64" height="64" class="s4-countdown-svg">
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" opacity="0.12" fill="<?php echo esc_attr($timer_bg); ?>" />
          <circle cx="32" cy="32" r="<?php echo esc_attr($normalizedRadius); ?>" stroke="<?php echo esc_attr($bar_color); ?>" stroke-width="<?php echo esc_attr($stroke); ?>" fill="none" stroke-linecap="round" stroke-dasharray="<?php echo esc_attr($circumference); ?>" stroke-dashoffset="0" transform="rotate(-90 32 32)" class="s4-circle-progress th-seconds-circle" />
