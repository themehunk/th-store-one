...
<div class="th-cd th-style2"
     style="background: <?php echo esc_attr($bg); ?>; color: <?php echo esc_attr($text); ?>; padding:10px; border-radius:6px;"
  ...
  <?php if ($show_bar && $has_stock_data) : ?>
    ...
    <!-- STOCK TEXT -->
    <div style="font-size:14px; margin-top:4px; opacity:0.7; text-align:center; color: <?php echo esc_attr($text); ?>">
