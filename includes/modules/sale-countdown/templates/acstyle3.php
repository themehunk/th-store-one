...
<div class="th-cd th-ac th-ac3"
  ...
  <?php if ( ! empty($end) ) : ?>
    <div class="th-timer-boxes">
      <div class="t-box"><span class="d">00</span><small><?php esc_html_e('D', 'th-store-one'); ?></small></div>
      <div class="t-box"><span class="h">00</span><small><?php esc_html_e('H', 'th-store-one'); ?></small></div>
      <div class="t-box"><span class="m">00</span><small><?php esc_html_e('M', 'th-store-one'); ?></small></div>
      <div class="t-box"><span class="s">00</span><small><?php esc_html_e('S', 'th-store-one'); ?></small></div>
    </div>
  <?php endif; ?>
  ...
  <?php if ( $show_bar  && ($args['sold']!== 0)) : ?>
    <div class="th-stock-row">
      <span>
        ...
        <?php esc_html_e('sold', 'th-store-one'); ?>
      </span>
      <span>
        <?php echo esc_html($remaining); ?>
        <?php esc_html_e('left', 'th-store-one'); ?>
      </span>
    </div>
