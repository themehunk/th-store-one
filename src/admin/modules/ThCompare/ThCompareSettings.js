...
const MODULE_ID = "th-product-compare";
const EXTENSION_ID = "th-product-compare";

export default function ThCompareSettings({ onModuleReady }) {
  ...
  const loadStatus = async () => {
    try {
      ...
      setPluginStatus({
        name: extension.name || "TH Product Compare",
