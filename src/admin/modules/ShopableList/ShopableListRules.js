                      ...
                      content: (
                        <div className="store-one-rule-body">
                          ...
                          <S1FieldGroup
                            ...
                            shortdescription="Products to feature in this video"
                            number={2}
                            description={__(
                          ...
                          <S1FieldGroup
                            number={3}
                            shortdescription="Playback and popup behavior"
                            title={__("Content", "th-store-one")}
                          >
                            <S1Field
                          ...
                          <S1Field label={__("Shortcode", "th-store-one")}>
                            ...
                            <div className="s1-shortcode-wrapper">
                              <textarea
                                readOnly
                                value={`[th_store_one_shoppable_video id="${
                                  index + 1
                                }"]`}
                              ...
                              <button
                                ...
                                onClick={() => {
                                  navigator.clipboard.writeText(
                                    `[th_store_one_shoppable_video id="${
                                      index + 1
                                    }"]`,
                                  );
                                }}
                    ...
                    },
                    {
                      ...
                      content: (
                        <div className="store-one-rule-body">
                          ...
                          <S1FieldGroup
                            number={1}
                            shortdescription="Heading shown above the shoppable list"
                            title="Title"
                          >
                            <S1Field
                          ...
                          <S1FieldGroup
                            number={2}
                            shortdescription="Grid or slider layout for displaying"
                            title="Layout"
                            description={__(
                        ...
                        <div className="store-one-rule-body">
                          ...
                          {rule.list_style == "style1" && (
                            <S1FieldGroup
                              title="Position"
                              number={1}
                              shortdescription="Position of product info"
                            >
                              <S1Field
                                label={__(
                          ...
                          <S1FieldGroup
                            title="Shoppable Card"
                            number={2}
                            shortdescription="Customize the appearance"
                          >
                            <S1Field>
                              <THBackgroundControl
                                allowGradient={false}
                          ...
                          <S1FieldGroup number={4} title="Product Info Color">
                          ...
                          <S1FieldGroup number={5} title="Progress Bar Color">
                            <S1Field>
                              <THBackgroundControl
                                label="Bar Fill"
                          ...
                          <S1FieldGroup number={6} title="Video Icon Color">
                            <div class="s1-field-group-row">
                              <S1Field>
                                <THBackgroundControl
                                  label="Background"
