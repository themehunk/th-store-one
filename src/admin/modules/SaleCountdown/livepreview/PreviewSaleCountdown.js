  ...
  return (
    <div className="s1-countdown-preview">
      ...
      <div className="s1-preview-area">
        ...
        {previewType === "archive" && (
          <>
            {archiveStyle === "acstyle1" && (
              <ArchiveStyle1 settings={settings} />
            )}
            {archiveStyle === "acstyle2" && (
              <ArchiveStyle2 settings={settings} />
            )}
            {archiveStyle === "acstyle3" && (
              <ArchiveStyle3 settings={settings} />
            )}
          </>
        )}
      </div>
