...
const PreviewPane = ({ currentModule, settings }) => {
  ...
  const activeRule =
    Array.isArray(moduleSettings.rules) && moduleSettings.rules.length > 0
          ...
          <div className="preview-content">
            <div className="preview-pane-box">
              {currentModule?.id === "frequently-bought" && activeRule && (
                <PreviewFBT key={currentModule.id} settings={activeRule} />
              )}
              ...
              {currentModule?.id === "trust-badges" && activeRule && (
                <TrustBadges key={currentModule.id} settings={activeRule} />
              )}
              ...
              {currentModule?.id === "buynow-button" && activeRule && (
                <PreviewBuyNow key={currentModule.id} settings={activeRule} />
              )}
              ...
              {currentModule?.id === "people-view" && activeRule && (
                <PreviewPeopleView
                  key={currentModule.id}
                  settings={activeRule}
                />
