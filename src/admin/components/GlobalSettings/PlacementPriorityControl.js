...
const PLACEMENTS = [
  {
    label: __("Before Product Summary", "th-store-one"),
    value: "woocommerce_single_product_summary",
  },
  {
    label: __("Before Add to Cart Form", "th-store-one"),
    value: "woocommerce_before_add_to_cart_form",
  },
  {
    label: __("After Add to Cart Form", "th-store-one"),
  ...
  {
    label: __("Before Product Meta", "th-store-one"),
    value: "woocommerce_product_meta_start",
  },
  {
    label: __("After Product Meta", "th-store-one"),
    value: "woocommerce_product_meta_end",
  },
  {
    label: __("After Product Summary", "th-store-one"),
