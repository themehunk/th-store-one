export const ICONS = {
 ...
 HeartSVG: (
  ...
  SNAPCHAT: (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
    <path d="M12 2c2.8 0 5 2.2 5 5 0 1-.3 2-.8 2.8.7.5 1.4.8 2.2 1-.2.4-.6.7-1.1.8-.4.1-.6.3-.6.6 0 .3.3.5.7.6-.3.6-.9.9-1.6 1-.4 0-.7.2-.9.6-.2.6-.5 1-.9 1-.3 0-.6-.2-.9-.2s-.6.2-.9.2c-.4 0-.7-.4-.9-1-.2-.4-.5-.6-.9-.6-.7-.1-1.3-.4-1.6-1 .4-.1.7-.3.7-.6 0-.3-.2-.5-.6-.6-.5-.1-.9-.4-1.1-.8.8-.2 1.5-.5 2.2-1C7.3 9 7 8 7 7c0-2.8 2.2-5 5-5z"/>
  </svg>
  ),
  TELEGRAM: (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
