    ...
    function playCurrentItem() {
      ...
      if (video) {
        ...
        if (video.readyState >= 1) {
          ...
          video.addEventListener("loadedmetadata", runProgress, { once: true });
        }
      }
    }
 ...
 =================================================== */
  ...
  function showMobileMultiTriggerCard() {
    ...
    jQuery(document)
      ...
      .on("click", ".th-mobile-mini-trigger-card.multi-trigger", function (e) {
        e.stopPropagation();
        showProductList();
      });
  }
      ...
      success: function (response) {
        ...
        jQuery(document)
          ...
          .on("click", ".th-qty-plus, .th-qty-minus", function (e) {
            ...
            jQuery("#th-custom-add-to-cart").attr("data-quantity", updatedQty);
            if (isVariable) {
  ...
  if (popup) {
    ...
    if (closeMainBtn) {
      closeMainBtn.addEventListener("click", () => {
        ...
        document.querySelectorAll(".th-popup-video").forEach((v) => v.pause());
      });
    }
  }
});
